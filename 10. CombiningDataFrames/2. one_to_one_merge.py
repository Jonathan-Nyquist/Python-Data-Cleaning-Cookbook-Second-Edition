...
nls97.loc[[135335, 999406], "originalid"] = nls97.originalid + 10000
# %%
nls97.originalid.head(2)
nls97add.loc[[0, 1], "originalid"] = nls97add.originalid + 20000
# %%
...
def checkmerge(dfleft, dfright, idvar):
    ...
    dfright["inright"] = "Y"
    dfboth = pd.merge(
        dfleft[[idvar, "inleft"]], dfright[[idvar, "inright"]], on=[idvar], how="outer"
    )
...
nlsnew = pd.merge(
    nls97, nls97add, left_on=["originalid"], right_on=["originalid"], how="right"
)
# %%
nlsnew.loc[nlsnew.index > 9999, ["gender", "birthyear", "motherage", "parentincome"]]
