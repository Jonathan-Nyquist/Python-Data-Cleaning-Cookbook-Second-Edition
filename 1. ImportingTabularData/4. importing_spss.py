...
nls97spss, metaspss = pyreadstat.read_sav(
    "data/nls97.sav", apply_value_formats=True, formats_as_category=True
)
nls97spss.columns = metaspss.column_labels
nls97spss.columns = (
    nls97spss.columns.str.lower()
...
nls97stata, metastata = pyreadstat.read_dta(
    "data/nls97.dta", apply_value_formats=True, formats_as_category=True
)
nls97stata.columns = metastata.column_labels
nls97stata.columns = (
    nls97stata.columns.str.lower()
    .str.replace(" ", "_")
    .str.replace("[^a-z0-9_]", "", regex=True)
)
nls97stata.dtypes
