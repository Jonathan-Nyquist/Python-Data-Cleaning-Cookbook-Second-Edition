...
# %%
covidtotalssdf.chat(
    "Show total cases per million 7 highest values and 7 lowest values of total cases per million sorted by total cases per million"
)

# %%
covidtotalssdf.chat(
    "Show total cases per million for locations with highest total cases per million in each region"
)

# %%
covidtotalssdf.chat(
    "Show total cases per million and total deaths per million for locationss with high total_cases_pm and low total_deaths_pm"
)
