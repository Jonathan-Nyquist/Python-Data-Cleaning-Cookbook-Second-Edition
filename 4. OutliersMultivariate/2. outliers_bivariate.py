...
covidtotals["total_cases_q"] = pd.qcut(
...
covidtotals["total_deaths_q"] = pd.qcut(
...
# %%
covidtotals.loc[
    (covidtotals.total_cases_q == "high") & (covidtotals.total_deaths_q == "low")
].T
...
# %%
covidtotals.loc[
    (covidtotals.total_cases < 40000000) & (covidtotals.total_deaths > 400000)
].T
# %%
covidtotals.loc[
    (covidtotals.total_cases > 30000000) & (covidtotals.total_deaths < 100000)
].T
