...
nls97.loc[
    (nls97.weeksworked20 == 0) & (nls97.wageincome20 > 0),
...
highwages = nls97.loc[
    nls97.wageincome20 > nls97.wageincome20.mean() + (nls97.wageincome20.std() * 3),
    ["wageincome20"],
]
# %%
highwages
...
workchanges = nls97.loc[
    ~nls97.loc[:, "weeksworked16":"weeksworked20"]
    .mean(axis=1)
    .between(nls97.weeksworked21 * 0.5, nls97.weeksworked21 * 2)
...
ltgrade12 = nls97.loc[
    nls97.highestgradecompleted < 12, ["highestgradecompleted", "highestdegree"]
]
# %%
