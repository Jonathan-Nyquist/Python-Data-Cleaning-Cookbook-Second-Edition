...
covidtotalsabb = covidtotalssdf.chat(
...
covidtotalsabb = covidtotalssdf.chat(
    "Grab total cases pm, total deaths pm, and location."
)
# %%
covidtotalsabb
...
# %%
covidtotalssdf.chat(
    "Plot total cases pm values against total deaths pm values with line"
)

# %%
covidtotalssdf.chat(
    "Plot total cases pm values against total deaths pm values with lmplot without extreme values"
)
