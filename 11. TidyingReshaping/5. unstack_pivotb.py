...
weeksworkedmelted.loc[weeksworkedmelted.originalid.isin([2, 3])].sort_values(
    ["originalid", "year"]
)
# %%
...
weeksworked = weeksworkedmelted.pivot(
    index="originalid", columns="year", values=["weeksworked"]
).reset_index()
