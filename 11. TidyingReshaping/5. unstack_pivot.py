...
# %%
workschoolmelted.loc[workschoolmelted.originalid.isin([1, 2])].sort_values(
    ["originalid", "year"]
)
workschool = workschoolmelted.pivot(
    index="originalid", columns="year", values=["weeksworked", "colenroct"]
).reset_index()
