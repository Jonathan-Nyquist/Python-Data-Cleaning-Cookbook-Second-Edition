...
coviddaily[["location", "casedate", "new_cases", "new_deaths"]].set_index(
    ["location", "casedate"]
...
coviddailytotals = (
    coviddaily.loc[coviddaily.casedate.between("2023-02-01", "2024-01-31")]
...
ltbrazilavgs = ltbrazil.groupby(["station"], as_index=False).agg(
    {"latabs": "first", "elevation": "first", "temperature": "mean"}
)
# %%
