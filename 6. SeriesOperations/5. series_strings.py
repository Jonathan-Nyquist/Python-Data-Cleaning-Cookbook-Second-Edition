...
pd.concat(
    [nls97.weeklyhrstv.head(), nls97.weeklyhrstv.str.findall("\d+").head()], axis=1
)
...
comphrsnew = [
    ...
    "B. 1 to 3 hours a week",
    "C. 4 to 6 hours a week",
    "D. 7 to 9 hours a week",
    "E. 10 hours or more a week",
]
# %%
