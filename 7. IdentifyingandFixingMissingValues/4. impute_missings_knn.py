...
wagedatalistimp = ["wageincomeimp", "weeksworked20imp", "parentincomeimp", "hdegnumimp"]
wagedataimp = pd.DataFrame(newvalues, columns=wagedatalistimp, index=wagedata.index)

# view imputed values
wagedata = wagedata.join(wagedataimp[["wageincomeimp", "weeksworked20imp"]])
# %%
wagedata[["wageincome20", "wageincomeimp", "weeksworked20", "weeksworked20imp"]].sample(
    10, random_state=7
)
