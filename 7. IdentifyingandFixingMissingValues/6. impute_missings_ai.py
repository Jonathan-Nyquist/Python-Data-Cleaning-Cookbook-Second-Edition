...
wagedatasdf = wagedatasdf.chat("Impute missing values based on average.")
...
wagedatasdf = wagedatasdf.chat("Impute missings based on most frequent value")
# %%
wagedatasdf.hdegnum.value_counts(dropna=False).sort_index()
...
wagedatasdf = wagedatasdf.impute_missing_values()
# %%
wagedatasdf.chat("Show the counts, means, and standard deviations as table")
