...
standtrans = make_pipeline(OutlierTrans(2), StandardScaler())
cattrans = make_pipeline(
    SimpleImputer(strategy="most_frequent"), OneHotEncoder(drop_last=True)
)
...
pipe1 = make_pipeline(coltrans, KNNImputer(n_neighbors=5), lr)
