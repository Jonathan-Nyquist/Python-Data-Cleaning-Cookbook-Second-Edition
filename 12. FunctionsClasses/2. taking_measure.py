...
missingsbycols, missingsbyrows = bd.getmissings(
    nls97[["weeksworked20", "weeksworked21"]], True
)
# %%
missingsbycols
# %%
missingsbyrows
missingsbycols, missingsbyrows = bd.getmissings(
    nls97[["weeksworked20", "weeksworked21"]]
)
# %%
missingsbyrows
...
bd.getcnts(nls97, ["maritalstatus", "colenroct00"])
bd.getcnts(nls97, ["maritalstatus", "colenroct00"], "colenroct00.str[0:1]=='1'")
# %%
